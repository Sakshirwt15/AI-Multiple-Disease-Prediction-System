...
with open(
    "Preprocessing Files/ML-Project-2-Diabetes_Prediction_Pre_Processing_Files/columns.pkl",
    "rb",
) as f:
    all_features_diabetes_disease = pickle.load(f)
with open(
    "Preprocessing Files/ML-Project-2-Diabetes_Prediction_Pre_Processing_Files/scaler.pkl",
    "rb",
) as f:
    scalers_diabetes_disease = pickle.load(f)
with open(
    "Best Features/ML-Project-2-Diabetes_Prediction_Best_Features/best_features_svc.json",
    "r",
) as file:
    best_features_svc_diabetes_disease = json.load(file)
with open(
    "Best Features/ML-Project-2-Diabetes_Prediction_Best_Features/best_features_lr.json",
    "r",
) as file:
    best_features_lr_diabetes_disease = json.load(file)
with open(
    "Best Features/ML-Project-2-Diabetes_Prediction_Best_Features/best_features_rfc.json",
    "r",
) as file:
    best_features_rfc_diabetes_disease = json.load(file)
with open(
    "Models/ML-Project-2-Diabetes_Prediction_Models/diabetes_disease_trained_svc_model.sav",
    "rb",
) as f:
    loaded_model_svc_diabetes_disease = pickle.load(f)
with open(
    "Models/ML-Project-2-Diabetes_Prediction_Models/diabetes_disease_trained_lr_model.sav",
    "rb",
) as f:
    loaded_model_lr_diabetes_disease = pickle.load(f)
with open(
    "Models/ML-Project-2-Diabetes_Prediction_Models/diabetes_disease_trained_rfc_model.sav",
    "rb",
) as f:
...
with open(
    "Preprocessing Files/ML-Project-9-Heart_Disease_Prediction_Pre_Processing_Files/columns.pkl",
    "rb",
) as f:
    all_columns_heart_disease = pickle.load(f)
with open(
    "Preprocessing Files/ML-Project-9-Heart_Disease_Prediction_Pre_Processing_Files/cat_columns.pkl",
    "rb",
) as f:
    cat_columns_heart_disease = pickle.load(f)
with open(
    "Preprocessing Files/ML-Project-9-Heart_Disease_Prediction_Pre_Processing_Files/encoder.pkl",
    "rb",
) as f:
    encoder_heart_disease = pickle.load(f)
with open(
    "Preprocessing Files/ML-Project-9-Heart_Disease_Prediction_Pre_Processing_Files/encoded_columns.pkl",
    "rb",
) as f:
    encoded_columns_heart_disease = pickle.load(f)
with open(
    "Preprocessing Files/ML-Project-9-Heart_Disease_Prediction_Pre_Processing_Files/training_columns.pkl",
    "rb",
) as f:
    training_columns_heart_disease = pickle.load(f)
with open(
    "Preprocessing Files/ML-Project-9-Heart_Disease_Prediction_Pre_Processing_Files/scaler.pkl",
    "rb",
) as f:
    scaler_heart_disease = pickle.load(f)
with open(
    "Best Features/ML-Project-9-Heart_Disease_Prediction_Best_Features/best_features_xgb.json",
    "r",
) as file:
    best_features_xgb_heart_disease = json.load(file)
with open(
    "Best Features/ML-Project-9-Heart_Disease_Prediction_Best_Features/best_features_rfc.json",
    "r",
) as file:
    best_features_rfc_heart_disease = json.load(file)
with open(
    "Best Features/ML-Project-9-Heart_Disease_Prediction_Best_Features/best_features_lr.json",
    "r",
) as file:
    best_features_lr_heart_disease = json.load(file)
with open(
    "Models/ML-Project-9-Heart_Disease_Prediction_Models/heart_disease_trained_xgb_model.sav",
    "rb",
) as f:
    loaded_model_xgb_heart_disease = pickle.load(f)
with open(
    "Models/ML-Project-9-Heart_Disease_Prediction_Models/heart_disease_trained_rfc_model.sav",
    "rb",
) as f:
    loaded_model_rfc_heart_disease = pickle.load(f)
with open(
    "Models/ML-Project-9-Heart_Disease_Prediction_Models/heart_disease_trained_lr_model.sav",
    "rb",
) as f:
...
with open(
    "Preprocessing Files/ML-Project-14-Parkinson's_Disease_Prediction_Pre_Processing_Files/columns.pkl",
    "rb",
) as f:
    all_features_parkinson_disease = pickle.load(f)
with open(
    "Preprocessing Files/ML-Project-14-Parkinson's_Disease_Prediction_Pre_Processing_Files/scaler.pkl",
    "rb",
) as f:
    scalers_parkinson_disease = pickle.load(f)
with open(
    "Best Features/ML-Project-14-Parkinson's_Disease_Prediction_Best_Features/best_features_knn.json",
    "r",
) as file:
    best_features_knn_parkinson_disease = json.load(file)
with open(
    "Best Features/ML-Project-14-Parkinson's_Disease_Prediction_Best_Features/best_features_xgb.json",
    "r",
) as file:
    best_features_xgb_parkinson_disease = json.load(file)
with open(
    "Best Features/ML-Project-14-Parkinson's_Disease_Prediction_Best_Features/best_features_rfc.json",
    "r",
) as file:
    best_features_rfc_parkinson_disease = json.load(file)
with open(
    "Models/ML-Project-14-Parkinson's_Disease_Prediction_Models/parkinsons_disease_trained_knn_model.sav",
    "rb",
) as f:
    loaded_model_knn_parkinson_disease = pickle.load(f)
with open(
    "Models/ML-Project-14-Parkinson's_Disease_Prediction_Models/parkinsons_disease_trained_xgb_model.sav",
    "rb",
) as f:
    loaded_model_xgb_parkinson_disease = pickle.load(f)
with open(
    "Models/ML-Project-14-Parkinson's_Disease_Prediction_Models/parkinsons_disease_trained_rfc_model.sav",
    "rb",
) as f:
...
with open(
    "Preprocessing Files/ML-Project-19-Breast_Cancer_Classification_Pre_Processing_Files/columns.pkl",
    "rb",
) as f:
    all_features_breast_cancer = pickle.load(f)
with open(
    "Preprocessing Files/ML-Project-19-Breast_Cancer_Classification_Pre_Processing_Files/scaler.pkl",
    "rb",
) as f:
    scalers_breast_cancer = pickle.load(f)
with open(
    "Best Features/ML-Project-19-Breast_Cancer_Classification_Best_Features/best_features_lr.json",
    "r",
) as file:
    best_features_lr_breast_cancer = json.load(file)
with open(
    "Best Features/ML-Project-19-Breast_Cancer_Classification_Best_Features/best_features_xgb.json",
    "r",
) as file:
    best_features_xgb_breast_cancer = json.load(file)
with open(
    "Best Features/ML-Project-19-Breast_Cancer_Classification_Best_Features/best_features_knn.json",
    "r",
) as file:
    best_features_knn_breast_cancer = json.load(file)
with open(
    "Models/ML-Project-19-Breast_Cancer_Classification_Models/parkinsons_disease_trained_lr_model.sav",
    "rb",
) as f:
    loaded_model_lr_breast_cancer = pickle.load(f)
with open(
    "Models/ML-Project-19-Breast_Cancer_Classification_Models/parkinsons_disease_trained_xgb_model.sav",
    "rb",
) as f:
    loaded_model_xgb_breast_cancer = pickle.load(f)
with open(
    "Models/ML-Project-19-Breast_Cancer_Classification_Models/parkinsons_disease_trained_knn_model.sav",
    "rb",
) as f:
...
def diabetes_prediction(input_data):
    ...
    df_diabetes_disease = pd.DataFrame(
        [input_data], columns=all_features_diabetes_disease
    )

    df_diabetes_disease[all_features_diabetes_disease] = (
        scalers_diabetes_disease.transform(
            df_diabetes_disease[all_features_diabetes_disease]
        )
    )

    df_best_features_svc_diabetes_disease = df_diabetes_disease[
        best_features_svc_diabetes_disease
    ]
    df_best_features_lr_diabetes_disease = df_diabetes_disease[
        best_features_lr_diabetes_disease
    ]
    df_best_features_rfc_diabetes_disease = df_diabetes_disease[
        best_features_rfc_diabetes_disease
    ]

    prediction1_diabetes_disease = loaded_model_svc_diabetes_disease.predict(
        df_best_features_svc_diabetes_disease
    )
    prediction2_diabetes_disease = loaded_model_lr_diabetes_disease.predict(
        df_best_features_lr_diabetes_disease
    )
    prediction3_diabetes_disease = loaded_model_rfc_diabetes_disease.predict(
        df_best_features_rfc_diabetes_disease
    )

    return (
        prediction1_diabetes_disease,
        prediction2_diabetes_disease,
        prediction3_diabetes_disease,
    )
...
def heart_disease_prediction(input_data):
    ...
    df_heart_disease[cat_columns_heart_disease] = df_heart_disease[
        cat_columns_heart_disease
    ].astype("str")

    input_data_encoded_heart_disease = encoder_heart_disease.transform(
        df_heart_disease[cat_columns_heart_disease]
    )

    input_data_encoded_df_heart_disease = pd.DataFrame(
        input_data_encoded_heart_disease, columns=encoded_columns_heart_disease
    )

    input_data_final_encoded_heart_disease = pd.concat(
        [
            df_heart_disease.drop(cat_columns_heart_disease, axis=1).reset_index(
                drop=True
            ),
            input_data_encoded_df_heart_disease,
        ],
        axis=1,
    )

    input_data_scaled_heart_disease = scaler_heart_disease.transform(
        input_data_final_encoded_heart_disease
    )

    input_data_df_heart_disease = pd.DataFrame(
        input_data_scaled_heart_disease, columns=training_columns_heart_disease
    )

    df_best_features_xgb_heart_disease = input_data_df_heart_disease[
        best_features_xgb_heart_disease
    ]
    df_best_features_rfc_heart_disease = input_data_df_heart_disease[
        best_features_rfc_heart_disease
    ]
    df_best_features_lr_heart_disease = input_data_df_heart_disease[
        best_features_lr_heart_disease
    ]

    prediction1_heart_disease = loaded_model_xgb_heart_disease.predict(
        df_best_features_xgb_heart_disease
    )
    prediction2_heart_disease = loaded_model_rfc_heart_disease.predict(
        df_best_features_rfc_heart_disease
    )
    prediction3_heart_disease = loaded_model_lr_heart_disease.predict(
        df_best_features_lr_heart_disease
    )

    return (
        prediction1_heart_disease,
        prediction2_heart_disease,
        prediction3_heart_disease,
    )


def parkinson_disease_prediction(input_data):

    df_parkinson_disease = pd.DataFrame(
        [input_data], columns=all_features_parkinson_disease
    )

    df_parkinson_disease[all_features_parkinson_disease] = (
        scalers_parkinson_disease.transform(
            df_parkinson_disease[all_features_parkinson_disease]
        )
    )

    df_best_features_knn_parkinson_disease = df_parkinson_disease[
        best_features_knn_parkinson_disease
    ]
    df_best_features_xgb_parkinson_disease = df_parkinson_disease[
        best_features_xgb_parkinson_disease
    ]
    df_best_features_rfc_parkinson_disease = df_parkinson_disease[
        best_features_rfc_parkinson_disease
    ]

    prediction1_parkinson_disease = loaded_model_knn_parkinson_disease.predict(
        df_best_features_knn_parkinson_disease
    )
    prediction2_parkinson_disease = loaded_model_xgb_parkinson_disease.predict(
        df_best_features_xgb_parkinson_disease
    )
    prediction3_parkinson_disease = loaded_model_rfc_parkinson_disease.predict(
        df_best_features_rfc_parkinson_disease
    )

    return (
        prediction1_parkinson_disease,
        prediction2_parkinson_disease,
        prediction3_parkinson_disease,
    )
...
def breast_cancer_prediction(input_data):
    ...
    df_breast_cancer[all_features_breast_cancer] = scalers_breast_cancer.transform(
        df_breast_cancer[all_features_breast_cancer]
    )

    df_best_features_lr_breast_cancer = df_breast_cancer[best_features_lr_breast_cancer]
    df_best_features_xgb_breast_cancer = df_breast_cancer[
        best_features_xgb_breast_cancer
    ]
    df_best_features_knn_breast_cancer = df_breast_cancer[
        best_features_knn_breast_cancer
    ]

    prediction1_breast_cancer = loaded_model_lr_breast_cancer.predict(
        df_best_features_lr_breast_cancer
    )
    prediction2_breast_cancer = loaded_model_xgb_breast_cancer.predict(
        df_best_features_xgb_breast_cancer
    )
    prediction3_breast_cancer = loaded_model_knn_breast_cancer.predict(
        df_best_features_knn_breast_cancer
    )

    return (
        prediction1_breast_cancer,
        prediction2_breast_cancer,
        prediction3_breast_cancer,
    )
...
def main():
    ...
    if selected == "Diabetes Prediction":
        ...
        DiabetesPedigreeFunction = st.number_input(
            "DiabetesPedigreeFunction value", format="%.3f"
        )
        ...
        diabetes_diagnosis_svc, diabetes_diagnosis_lr, diabetes_diagnosis_rfc = (
            diabetes_prediction(
                [
                    Pregnancies,
                    Glucose,
    ...
    if selected == "Heart Disease Prediction":
        ...
        with col3:
            option7 = st.selectbox(
                "The slope of the peak exercise ST segment", ("0", "1", "2", "3", "4")
            )
            if option7 == "0":
        ...
        with col1:
            option7 = st.selectbox(
                "Thal", ("None", "Normal", "Fixed defect", "Reversable defect")
            )
            if option7 == "None":
                thal = 0
            elif option7 == "Normal":
